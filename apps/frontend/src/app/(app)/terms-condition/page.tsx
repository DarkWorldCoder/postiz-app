...
export const metadata: Metadata = {
  title: 'ProERP Terms of Service',
  description:
    'Terms of Service for ProERP by WiseAdmit, including social posting, connected accounts, and platform compliance.',
};
...
export default function TermsConditionPage() {
  return (
    <LegalShell
      ...
      description="These Terms of Service govern your access to and use of ProERP, the WiseAdmit social media management service for connecting social accounts, scheduling content, publishing posts, and managing social workflows."
    >
      <LegalSection title="Effective Date and Agreement">
        ...
        <p>
          ...
          of ProERP. By accessing ProERP, creating an account, connecting a
          social platform, uploading content, scheduling posts, or using any
          ProERP feature, you agree to these Terms.
        </p>
      </LegalSection>

      <LegalSection title="The ProERP Service">
        <p>
          ProERP helps users and organizations manage social media workflows in
      ...
      <LegalSection title="Accounts and Authorized Users">
        <LegalList
          items={[
            ...
            'You are responsible for all activity under your ProERP account and workspace.',
            ...
            'If you use ProERP for an organization, you represent that you have authority to bind that organization to these Terms.',
          ]}
        />
      </LegalSection>
      ...
      <LegalSection title="Connected Social Platforms">
        <p>
          ProERP integrates with third-party platforms such as TikTok, Meta,
          ...
          rules, privacy rules, and content guidelines when using ProERP.
        </p>
        <p>
      ...
      <LegalSection title="Authorized Features and Permissions">
        <p>
          ...
          authorize ProERP to use the permissions required for the features you
          enable:
        </p>
        <LegalList
          items={[
        ...
        />
        <p>
          You must only grant ProERP access to accounts, Pages, businesses,
      ...
      <LegalSection title="Content and Publishing Responsibilities">
        <LegalList
          items={[
            'You are solely responsible for all text, images, videos, audio, captions, links, metadata, advertising material, messages, replies, and other content that you create, upload, schedule, publish, or manage through ProERP.',
      ...
      <LegalSection title="Acceptable Use">
        ...
        <LegalList
          items={[
            ...
            'Interfere with ProERP security, abuse APIs, bypass rate limits, introduce malware, or attempt unauthorized access.',
      ...
      <LegalSection title="User Content License">
        <p>
          ...
          ProERP, provide requested features, publish or upload content to
      ...
      <LegalSection title="Privacy and Data Deletion">
        <p>
          WiseAdmit processes information as described in the ProERP Privacy
      ...
      <LegalSection title="Subscriptions, Fees, and Taxes">
        <p>
          Some ProERP features may require a paid plan. If you purchase a paid
      ...
      <LegalSection title="Service Changes and Availability">
        <p>
          ...
          ProERP, maintain security, comply with law, respond to platform API
          changes, or address operational needs. We work to keep ProERP
      ...
      <LegalSection title="Disclaimers">
        <p>
          ProERP is provided on an "as is" and "as available" basis to the
      ...
      <LegalSection title="Limitation of Liability">
        <p>
          ...
          liability for claims relating to ProERP will not exceed the amount you
          paid to WiseAdmit for ProERP in the three months before the event
      ...
      <LegalSection title="Indemnification">
        <p>
          ...
          content, your connected accounts, your use of ProERP, your violation
      ...
      <LegalSection title="Termination">
        <p>
          You may stop using ProERP at any time. WiseAdmit may suspend or
      ...
      <LegalSection title="Governing Law and Disputes">
        <p>
          ...
          to resolve disputes informally by contacting support@wiseadmit.io. If
      ...
      <LegalSection title="Changes to These Terms">
        <p>
          ...
          of ProERP after updated Terms become effective means you accept the
          updated Terms.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Contact WiseAdmit">
        <p>
          ...
          ProERP, contact WiseAdmit at support@wiseadmit.io.
        </p>
      </LegalSection>
    </LegalShell>
  );
